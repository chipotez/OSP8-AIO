...
CONFIG_DEFAULT_PASSWORD=redhat2016
...
CONFIG_CONTROLLER_HOST=192.168.122.11

# List the servers on which to install the Compute service.
CONFIG_COMPUTE_HOSTS=192.168.122.11,192.168.122.12
...
CONFIG_NETWORK_HOSTS=192.168.122.11
...
CONFIG_STORAGE_HOST=192.168.122.11

# (Unsupported!) Server on which to install OpenStack services
# specific to OpenStack Data Processing (sahara).
CONFIG_SAHARA_HOST=192.168.122.11
...
CONFIG_SELFSIGN_CACERT_SUBJECT_CN=osp81.poc.redhat.com

CONFIG_SELFSIGN_CACERT_SUBJECT_MAIL=admin@osp81.poc.redhat.com
...
CONFIG_AMQP_HOST=192.168.122.11
...
CONFIG_KEYSTONE_ADMIN_TOKEN=80a9fea4c16d4b5f95bf1337c6b10df6
...
CONFIG_KEYSTONE_ADMIN_PW=redhat2016

# Password to use for the Identity service 'demo' user.
CONFIG_KEYSTONE_DEMO_PW=redhat2016
...
CONFIG_KEYSTONE_LDAP_URL=ldap://192.168.122.11
...
# database.
CONFIG_GLANCE_DB_PW=c79b7b4dbf1d401f

# Password to use for the Image service to authenticate with the
# Identity service.
CONFIG_GLANCE_KS_PW=e3542632fb734637
...
# the database.
CONFIG_CINDER_DB_PW=2c9c6bf35d084e88
...
CONFIG_CINDER_KS_PW=99a7caf922414e64
...
# database.
CONFIG_NOVA_DB_PW=81fe6afcb5d642e8

# Password to use for the Compute service to authenticate with the
# Identity service.
CONFIG_NOVA_KS_PW=d64b2641e41a4cfc
...
CONFIG_NEUTRON_KS_PW=41ec7427c9bb4f04

# The password to use for OpenStack Networking to access the
# database.
CONFIG_NEUTRON_DB_PW=a4a9cfb4ced849af
...
CONFIG_NEUTRON_METADATA_PW=c34211fa08f34363
...
CONFIG_HORIZON_SECRET_KEY=11c829cc672947028b606270ffb99b5a
...
# the Identity service.
CONFIG_SWIFT_KS_PW=34703a6ad39b418e
...
CONFIG_SWIFT_HASH=25188b9f61134296
...
# Orchestration.
CONFIG_HEAT_DOMAIN_PASSWORD=redhat2016
...
CONFIG_CEILOMETER_SECRET=0d74ea7f4c4e4c4d

# Password to use for Telemetry to authenticate with the Identity
# service.
CONFIG_CEILOMETER_KS_PW=f10801f04f1e4b2e
...
CONFIG_MONGODB_HOST=192.168.122.11

# IP address of the server on which to install the Redis master
# server.
CONFIG_REDIS_MASTER_HOST=192.168.122.11
...
# the Compute service.
CONFIG_TROVE_NOVA_PW=redhat2016
